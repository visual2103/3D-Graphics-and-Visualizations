...
namespace gps {
    ...
    void SkyBox::Draw(gps::Shader shader, glm::mat4 viewMatrix, glm::mat4 projectionMatrix)
    {
        ...
        if (viewLoc == -1 || projLoc == -1) {
            fprintf(stderr, "ERROR: Shader uniforms 'view' or 'projection' not found!\n");
        }
    ...
    void SkyBox::InitSkyBox()
    {
        ...
        if (skyboxVAO == 0) {
            fprintf(stderr, "ERROR: VAO not generated for skybox.\n");
        }

        glGenBuffers(1, &skyboxVBO);
        if (skyboxVBO == 0) {
            fprintf(stderr, "ERROR: VBO not generated for skybox.\n");
        }
